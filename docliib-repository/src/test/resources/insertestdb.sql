...
VALUES (nextval('catalogs_id_seq'), 'test_parent', '/')
...
INSERT INTO documents_versions(id, document_id,description,importance,is_moderated)
VALUES (1,1,'test description','Important',false)
on conflict do nothing;
